...
```
# Sample of 10 flies
# Sample mean of antenna length= 0.4mm
# pop mean= 0.3 with stnd dev of 0.1 
# is the sample population different from the overall pop?
      #difference of samp and pop, over stnd err
